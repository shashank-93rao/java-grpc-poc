...
public final class HelloServiceGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "io.shashank.grpc.service.hello.HelloService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<io.shashank.grpc.service.hello.Hello,
      io.shashank.grpc.service.hello.HelloResponse> getHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "hello",
      requestType = io.shashank.grpc.service.hello.Hello.class,
      responseType = io.shashank.grpc.service.hello.HelloResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<io.shashank.grpc.service.hello.Hello,
      io.shashank.grpc.service.hello.HelloResponse> getHelloMethod() {
    io.grpc.MethodDescriptor<io.shashank.grpc.service.hello.Hello, io.shashank.grpc.service.hello.HelloResponse> getHelloMethod;
    if ((getHelloMethod = HelloServiceGrpc.getHelloMethod) == null) {
      synchronized (HelloServiceGrpc.class) {
        if ((getHelloMethod = HelloServiceGrpc.getHelloMethod) == null) {
          HelloServiceGrpc.getHelloMethod = getHelloMethod =
              io.grpc.MethodDescriptor.<io.shashank.grpc.service.hello.Hello, io.shashank.grpc.service.hello.HelloResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "hello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.shashank.grpc.service.hello.Hello.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.shashank.grpc.service.hello.HelloResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void hello(io.shashank.grpc.service.hello.Hello request,
        io.grpc.stub.StreamObserver<io.shashank.grpc.service.hello.HelloResponse> responseObserver) {
  ...
  public static final class HelloServiceStub
    ...
    /**
     */
    public void hello(io.shashank.grpc.service.hello.Hello request,
        io.grpc.stub.StreamObserver<io.shashank.grpc.service.hello.HelloResponse> responseObserver) {
  ...
  public static final class HelloServiceBlockingStub
    ...
    /**
     */
    public io.shashank.grpc.service.hello.HelloResponse hello(io.shashank.grpc.service.hello.Hello request) {
  ...
  public static final class HelloServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<io.shashank.grpc.service.hello.HelloResponse> hello(
        io.shashank.grpc.service.hello.Hello request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_HELLO:
          serviceImpl.hello((io.shashank.grpc.service.hello.Hello) request,
              (io.grpc.stub.StreamObserver<io.shashank.grpc.service.hello.HelloResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              io.shashank.grpc.service.hello.Hello,
              io.shashank.grpc.service.hello.HelloResponse>(
  ...
  private static abstract class HelloServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return io.shashank.grpc.service.hello.HelloOuterClass.getDescriptor();
    }
